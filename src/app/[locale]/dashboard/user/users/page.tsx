...
import UserManagementClient from '@/components/user/users/UserManagementClient';

// Define default pagination parameters
const DEFAULT_PAGE = 1;
const DEFAULT_LIMIT = 20;

export default async function UserUsersPage() {
  const supabase = await createClient();

  // 1. Check if user is logged in and is a user
