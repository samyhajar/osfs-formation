...
export default async function FormantUsersPage({ searchParams }: FormantUsersPageProps) {
  ...
  // Ensure user is a formator for this page
  if (profileError || !profile || profile.role !== 'formator') {
    console.error('Access denied or profile fetch error:', profileError);
    redirect('/dashboard'); // Redirect if not a formator
  }
