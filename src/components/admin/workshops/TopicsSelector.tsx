...
export function TopicsSelector({ topics, onChange, disabled = false }: TopicsSelectorProps) {
  return (
    <div>
      <label htmlFor="topics-section" className="block text-sm font-medium text-gray-700 mb-2">
        Topics
      </label>
      <div id="topics-section" className="flex flex-wrap gap-2 mb-2">
      ...
      <FormField
        ...
        onChange={(value) => {
          const customTopics = value.split(',').map(t => t.trim()).filter(t => t);
